...
function [trainingData] = getFeatures(~,~)
load rawData.mat
...
% save features in workspace
features=[accelX_mean, accelY_mean, accelZ_mean, gyroX_mean, gyroY_mean, ...
...
% % Uncomment below to analyze rawData and trainingData (verify results)
train_size=size(trainingData);
train_row=train_size(1);
% disp(train_row);
if train_row ~= 50
